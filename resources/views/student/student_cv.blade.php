                                        ...
                                        <div class="portlet-body">
                                            <table class="table table-striped table-bordered table-advance table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="hidden-xs">
                                                        <i class="fa fa-question"></i> Level
                                                    </th>
                                                    <th>
                                                        <i class="fa fa-bookmark"></i> Experience
                                                    </th>
                                                ...
                                                <form action="#" class="form-horizontal" method="post"
                                                    ...
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group form-md-line-input">
                                                            ...
                                                            <div class="col-md-9">
                                                                <textarea class="form-control" name="memo" id="info"
                                                                          rows="5">{{$student_cv->info}}</textarea>
                                                                <div class="form-control-focus"></div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group form-md-line-input">
                                                            ...
                                                            <div class="col-md-9">
                                                                <textarea class="form-control" name="memo" id="purpose"
                                                                          rows="5">{{$student_cv->purpose}}</textarea>
                                                                <div class="form-control-focus"></div>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                    ...
                                                    <div class="form-actions">
                                                        <div class="row">
                                                            <div class="col-md-offset-3 col-md-9">
                                                                <button type="submit" id="edit_information"
                                                                        onclick="updateCv('{{Auth::user()->user_id}}')"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <form action="{{ url('dropzone') }}" method="post"
                                                  class="dropzone dropzone-file-area dz-clickable" id="my-dropzone"
                                                  style="width: 500px;">

                                                <h3 class="sbold">Drop files here or click to upload</h3>
                                                <p> This is just a demo dropzone. Selected files are not actually
                                                    uploaded. </p>
