                    ...
                    <div class="col-md-9">
                        <div class="row">
                            <div class="col-md-8 profile-info">
                                ...
                                <h1 class="font-green sbold uppercase">{{$student->last_name}} {{$student->first_name}}</h1>
                        ...
                        <div class="tabbable-line tabbable-custom-profile">
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="#tab_1_11" data-toggle="tab" aria-expanded="true"> Current Mark </a>
                                </li>
                                <li class="">
                                    <a href="#tab_1_22" data-toggle="tab" aria-expanded="false"> History </a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                    ...
                                    <div class="portlet-body">
                                        <table class="table table-striped table-bordered table-advance table-hover">
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <i class="fa fa-info"></i> Student ID </th>
                                                    </th>
                                                    <th>
                                                        <i class="fa fa-briefcase"></i> Company </th>
                                                    <th>
                                                        <i class="fa fa-bookmark"></i> Company Mark </th>
                                                    <th class="hidden-xs">
                                                        <i class="fa fa-question"></i> Lecturer Mark </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @foreach($currentMark as $current)
                                                <tr>
                                                    <td>
                                                        <a href="javascript:;"> {{$current->student_id}} </a>
                                                    </td>
                                                    <td class="hidden-xs"> Company Name </td>
                                                    <td>
                                                        <span class="label label-success label-sm"> {{$current->mark_instructor}} </span>
                                                    </td>
                                                    <td>
                                                        <span class="label label-success label-sm"> {{$current->mark_lecturer}} </span>
                                                    </td>
                                    ...
                                    <div class="portlet-body">
                                        <table class="table table-striped table-bordered table-advance table-hover">
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <i class="fa fa-info"></i> Period </th>
                                                    </th>
                                                    <th>
                                                        <i class="fa fa-briefcase"></i> Company </th>
                                                    <th class="hidden-xs">
                                            ...
                                            <tbody>
                                                @foreach($markHistory as $history)
                                                <tr>
                                                    <td>
                                                        <a href="javascript:;"> {{$history->period_id}} </a>
                                                    </td>
                                                    <td class="hidden-xs"> Company Name </td>
                                                    <td>
                                                        <span class="label label-success label-sm"> {{$history->lecturer_mark}} </span>
                                                    </td>
                                                    <td>
                                                        <span class="label label-success label-sm"> {{$history->instructor_mark}} </span>
                                                    </td>
