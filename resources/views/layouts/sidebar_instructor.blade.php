    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
            <li class="nav-item start ">
                <a href="/instructor" class="nav-link nav-toggle">
                    <i class="icon-home"></i>
            ...
            <li class="nav-item  ">
                <a href="/instructor/profile/{{Auth::user()->user_id}}" class="nav-link nav-toggle">
            ...
            <li class="nav-item  ">
                <a href="/instructor/intern" class="nav-link nav-toggle">
            ...
            <li class="nav-item  ">
                <a href="/instructor/topic/manage" class="nav-link nav-toggle">
                    <i class="icon-feed"></i>
