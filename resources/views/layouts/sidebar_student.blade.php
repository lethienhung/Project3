...
<div class="page-sidebar-wrapper">
    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
            ...
            <li class="nav-item  ">
                <a href="/student/profile/{{Auth::user()->user_id}}" class="nav-link nav-toggle">
                    <i class="icon-diamond"></i>
                    <span class="title">Thông tin cá nhân</span>
                </a>
            </li>
            <li class="nav-item  ">
                <a href="/student/cv/{{Auth::user()->user_id}}" class="nav-link nav-toggle">
                    <i class="icon-puzzle"></i>
                    <span class="title">Thông tin CV</span>
                </a>
            </li>
            ...
            <li class="nav-item  ">
                <a href="/student/intern/{{Auth::user()->user_id}}" class="nav-link nav-toggle">
                    <i class="icon-puzzle"></i>
