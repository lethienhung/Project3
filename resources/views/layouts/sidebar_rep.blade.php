    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
            <li class="nav-item start ">
                <a href="/representation" class="nav-link nav-toggle">
                    <i class="icon-home"></i>
            ...
            <li class="nav-item  ">
                <a href="/company/representation/{{Auth::user()->user_id}}" class="nav-link nav-toggle">
            ...
            <li class="nav-item  ">
                <a href="/company/intern" class="nav-link nav-toggle">
            ...
            <li class="nav-item  ">
                <a href="/company/intern" class="nav-link nav-toggle">
                    <i class="icon-feed"></i>
                    <span class="title">Quản lý đề tài</span>
                </a>
            </li>
            <li class="nav-item  ">
                <a href="/company/instructor/create" class="nav-link nav-toggle">
                    <i class="icon-feed"></i>
