                                                        ...
                                                        <div class="form-group form-md-line-input">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control"
                                                                       ...
                                                                       value="{{$representation->first_name}}">
                                                        ...
                                                        <div class="form-group form-md-line-input">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" name="last_name"
                                                                       id="last_name"
                                                                       value="{{$representation->last_name}}">
                                                                <div class="form-control-focus"></div>
                                                        ...
                                                        <div class="form-group form-md-line-input">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" placeholder=""
                                                                       ...
                                                                       value="{{$representation->phone_number}}">
                                                                <div class="form-control-focus"></div>
                                                        ...
                                                        <div class="form-group form-md-line-input">
                                                            ...
                                                            <div class="col-md-9">
                                                                <textarea class="form-control" name="memo" id="about_me"
                                                                          rows="5">{{$company->information}}</textarea>
                                                                <div class="form-control-focus"></div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-offset-3 col-md-9">
                                                                <button type="submit" id="edit_information"
                                                                        onclick="update('{{Auth::user()->user_id}}')"
