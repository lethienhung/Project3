                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_1_1">
                            <div class="m-heading-1 border-green m-bordered">
                                ...
                                <p> This jQuery plugin makes simple clientside form validation easy, whilst still
                                    offering plenty
                                    of customization options. For more info please check out
                                    <a class="btn red btn-outline" href="http://jqueryvalidation.org" target="_blank">the
                                    ...
                                    <div class="portlet-body">
                                        <table class="table table-striped table-bordered table-hover table-header-fixed"
                                            ...
                                            @foreach($topic as $tp)
                                                <tr>
                                                    <td> {{$tp->id}} </td>
                                                    <td><a href="/topic/{{$tp->topic_id}}"
                                                           target="_blank">{{$tp->topic_id}}</a></td>
                                                    <td> {{$tp->title}} </td>
                                                    <td> {{$tp->quantity}} </td>
                                                    <td>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="portlet light portlet-fit portlet-form bordered">
                                        ...
                                        <input value="{{Auth::user()->email}}" type="hidden" id="useremail">
                                                ...
                                                <div class="form-body">
                                                    <div class="form-group form-md-line-input">
                                                        <input type="text" class="form-control" name="name"
                                                               v-model="title" placeholder="Enter your title">
                                                    ...
                                                    <div class="form-group form-md-line-input">
                                                        <input type="text" class="form-control" v-model="documentation"
                                                        ...
                                                        <div class="input-group">
                                                            <div class="input-group-control">
                                                                <input type="text" class="form-control"
                                                                       v-model="phone_number" name="number2"
                                                                       placeholder="Phone Number">
                                                                <label for="form_control_1">Enter your Phone
                                                                    number</label>
                                                            </div>
                                                            <span class="input-group-btn btn-right">
                                                            <button type="button" class="btn green-haze dropdown-toggle"
                                                    ...
                                                    <div class="form-group form-md-line-input">
                                                        <input type="text" class="form-control" name="required_field"
                                                               v-model="position" placeholder="Enter your title">
                                                    ...
                                                    <div class="form-group form-md-line-input">
                                                        <input type="text" class="form-control" v-model="salary"
                                                               name="required_field" placeholder="Enter your title">
                                                    ...
                                                    <div class="form-group form-md-line-input">
                                                        <input type="text" class="form-control" name="required_field"
                                                               v-model="priority" placeholder="Enter your title">
                                                    ...
                                                    <div class="form-group form-md-line-input">
                                                        <textarea class="form-control" name="memo" v-model="content"
                                                                  rows="10"></textarea>
                                                        <label for="form_control_1">Content</label>
                                                        <span class="help-block">Some help goes here...</span>
                                                    </div>
                                                    <div class="form-group form-md-line-input">
                                                        <textarea class="form-control" name="other_require"
                                                                  v-model="other_require" rows="3"></textarea>
                                                    ...
                                                    <div class="form-group form-md-line-input">
                                                        <label class="col-md-3 control-label" for="form_control_1">Second
                                                            Skills</label>
                                                        <div class="col-md-6">
                                                    ...
                                                    <div class="form-group form-md-line-input">
                                                        <label class="col-md-3 control-label" for="form_control_1">Third
                                                            Skills</label>
                                                        <div class="col-md-6">
                                                    ...
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <div class="col-md-3">
                                                            <select class="form-control" id="field" v-model="field">
                                                                <option value="">Select</option>
                                                                @foreach($field as $f)
                                                    ...
                                                    <div class="form-actions">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <button type="submit" @click="createTopic()" id="submit"
                                    ...
                                    <div class="portlet-body">
                                        <table class="table table-striped table-bordered table-hover table-header-fixed"
                                            ...
                                            <tr v-for="std in list">
                                                ...
                                                <td v-if="std.company_confirm === 'Pending'">
                                                    <div class="btn-group btn-group btn-group-solid">
                                                        <a href="javascript:;"
                                                           @click="approve(std.student_id,std.topic_id)"
                                                           class="btn btn-icon-only green">
                                                            <i class="fa fa-check"></i>
                                                        </a>
                                                        <a href="javascript:;"
                                                           @click="decline(std.student_id,std.topic_id)"
                                                           class="btn btn-icon-only red">
                                                            <i class="fa fa-times"></i>
                                                        </a>
                                                    </div>
                                                </td>
                                                <td v-else-if="std.company_confirm === 'Approved'">
                                                    <div class="btn-group btn-group btn-group-solid">
                                                ...
                                                <td v-else-if="std.company_confirm === 'Declined'">
                                                    <div class="btn-group btn-group btn-group-solid">
