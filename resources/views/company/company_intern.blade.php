                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_1_1">
                        <div class="m-heading-1 border-green m-bordered">
                            ...
                            <p> This jQuery plugin makes simple clientside form validation easy, whilst still offering plenty of customization
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-header-fixed" id="sample_1">
                                        ...
                                        @foreach($topic as $tp)
                                            <tr>
                                                ...
                                                <td> {{$tp->title}} </td>
                                                <td> {{$tp->quantity}} </td>
                                                <td> <label class="success">{{$tp->status}}</label> </td>
                                            </tr>
                                        @endforeach                                               
                                        </tbody>
                                    </table>
                                        ...
                                        <form action="#" id="form_sample_2">
                                            <div class="form-body">
                                                <div class="form-group form-md-line-input">
                                                    <input type="text" class="form-control" name="name" id="title" placeholder="Enter your title">
                                                ...
                                                <div class="form-group form-md-line-input">
                                                    <input type="text" class="form-control" id="documentation" name="url" placeholder="Enter URL">
                                                    <label for="form_control_1">Topic Documentation URL</label>
                                                </div>
                                                <div class="form-group form-md-line-input">
                                                    <input type="text" class="form-control" id="quantity" name="number" placeholder="Enter number">
                                                ...
                                                <div class="form-group form-md-line-input">
                                                    <div class="input-group">
                                                        <div class="input-group-control">
                                                            <input type="text" class="form-control" id="phone_number" name="number2" placeholder="Phone Number">
                                                ...
                                                <div class="form-group form-md-line-input">
                                                    <input type="text" class="form-control" name="required_field" id="position" placeholder="Enter your title">
                                                ...
                                                <div class="form-group form-md-line-input">
                                                    <input type="text" class="form-control" name="required_field" id="salary" placeholder="Enter your title">
                                                ...
                                                <div class="form-group form-md-line-input">
                                                    <input type="text" class="form-control" name="required_field" id="priority" placeholder="Enter your title">
                                                ...
                                                <div class="form-group form-md-line-input">
                                                    <textarea class="form-control" name="memo" id="content" rows="10"></textarea>
                                                    <label for="form_control_1">Content</label>
                                                    <span class="help-block">Some help goes here...</span>
                                                </div>
                                                <div class="form-group form-md-line-input">
                                                    <textarea class="form-control" name="other_require" id="other_require" rows="3"></textarea>
