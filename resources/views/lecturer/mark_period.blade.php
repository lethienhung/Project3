							...
							<div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                    <div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <span class="profile-desc-text"> Khối lượng công việc đã thực hiện trong thời gian thực tập</span></br>
                                                <span class="profile-desc-text"> Chất lượng công việc đã thực hiện trong thời gian thực tập </span></br>
                                                <span class="profile-desc-text"> Khả năng tự hoàn thành công việc và cách giải quyết các vấn đề phát sinh </span></br>
                                                <span class="profile-desc-text"> Viết tài liệu về công việc đã thực hiện </span></br>
                                                <span class="profile-desc-text"> Thuyết trình </span></br>
                                ...
                                <div class="portlet-body">
                                    <div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <span class="profile-desc-text"> Đúng giờ</span></br>
                                                <span class="profile-desc-text"> Vẻ ngoài (quần áo, tác phong nơi công sở, …) </span></br>
                                                <span class="profile-desc-text"> Giữ gìn hình ảnh cho cơ sở thực tập và cho sản phẩm đã thực hiện trong quá trình làm việc </span></br>
                                                <span class="profile-desc-text"> Làm việc nhóm </span></br> 
                                                <span class="profile-desc-text"> Quan hệ, giao tiếp với nhân viên, khách hàng của cơ sở thực tập  </span></br>
                                ...
                                <div class="portlet-body">
                                    <div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <span class="profile-desc-text"> Cải thiện năng lực, trình độ kỹ thuật</span></br>
                                                <span class="profile-desc-text"> Cải thiện thái độ, ý thức </span></br>
