                            ...
                            <div class="profile-sidebar">
                                ...
                                <div class="portlet light profile-sidebar-portlet bordered">
                                    ...
                                    <div class="profile-usertitle">
                                        <div class="profile-usertitle-name"> {{$lecturer->last_name}} {{$lecturer->first_name}} </div>
                                        <div class="profile-usertitle-job"> Giảng viên hướng dẫn </div>
                                    </div>
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <!-- END STAT -->
                                    <div>
                                        <h4 class="profile-desc-title">About {{$lecturer->last_name}} {{$lecturer->first_name}}</h4>
                                                    ...
                                                    <div class="tab-pane active" id="tab_1_1">
                                                        <form role="form" action="#" method="post" id="form1">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" placeholder="{{$lecturer->last_name}}" class="form-control" name="last_name" /> </div>
                                                            <div class="form-group">
                                                                <label class="control-label">Tên</label>
                                                                <input type="text" placeholder="{{$lecturer->first_name}}" class="form-control" name="first_name" /> </div>
                                                            <div class="form-group">
				                                                <label class="control-label">Ngày sinh</label>
				                                                <input class="form-control form-control-inline input-medium date-picker" size="16" type="text" value="" name="date_of_birth" placeholder="{{$lecturer->date_of_birth}}" />
                                                            </div>
                                                            <div class="form-group">
                                                            	...
                                                            	<div class="mt-radio-inline">
				                                                    <label class="mt-radio">
				                                                        ...
				                                                        @if($lecturer->gender == "Nam") checked @endif> Nam
				                                                        <span></span>
				                                                    </label>
				                                                    <label class="mt-radio">
				                                                        <input type="radio" name="gender" id="optionsRadios5" value="Nu" class="form-control"
				                                                        @if($lecturer->gender == "Nu") checked @endif> Nữ
				                                                        <span></span>
				                                                    </label>                                     
				                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" placeholder="{{$lecturer->phone_number}}" class="form-control" name="phone_number" /> </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="margiv-top-10">
                                                                <button class="btn green" onclick="add()">
                                                                	Lưu thay đổi
                                                                </button>
                                                    ...
                                                    <div class="tab-pane" id="tab_1_3">
                                                        <form action="#">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="password" class="form-control" name="currentpassword" /> </div>
                                                            <div class="form-group">
