                ...
                <div class="cbp-caption-activeWrap">
                    <div class="cbp-l-caption-alignCenter">
                        <div class="cbp-l-caption-body">
                            <a href="/topic/{{$lf->topic_id}}" target="_blank"
                               class="cbp-singlePage cbp-l-caption-buttonLeft btn red uppercase" rel="nofollow">more
                                info</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="graphic {{str_replace(' ','-',$ls->field_name)}} cbp-item">
            <div class="cbp-caption">
                ...
                <div class="cbp-caption-activeWrap">
                    <div class="cbp-l-caption-alignCenter">
                        <div class="cbp-l-caption-body">
                            <a href="/topic/{{$ls->topic_id}}" target="_blank"
                               class=" cbp-l-caption-buttonLeft btn red uppercase" rel="nofollow">more info</a>
                        </div>
                    </div>
                </div>
            </div>
