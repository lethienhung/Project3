                        ...
                        <div class="blog-single-content bordered blog-container">
                            ...
                            <div class="blog-comments">
                                ...
                                <div class="c-comment-list">
                                        ...
                                        <div class="media-left">
                                            <a href="#">
                                                <img class="media-object" alt=""
                                                     src="../assets/pages/img/avatars/team1.jpg"> </a>
                                        </div>
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="#">
                                                <img class="media-object" alt=""
                                                     src="../assets/pages/img/avatars/team3.jpg"> </a>
                                        </div>
                                        <div class="media-body">
                                            <h4 class="media-heading">
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="#">
                                                <img class="media-object" alt=""
                                                     src="../assets/pages/img/avatars/team7.jpg"> </a>
                                        </div>
                                        <div class="media-body">
                                            <h4 class="media-heading">
                                ...
                                <form action="#">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn blue uppercase btn-md sbold btn-block">Submit
                                        </button>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="blog-single-sidebar-search" id="aspiration">
                                @if(Auth::user()->role == "student" && $stdAssigned == 0 && $countNumberAspiration < 3)
                                    <a class="btn btn-success"
                                       @click="sendCv('{{Auth::user()->user_id}}','{{$topic_id->topic_id}}')"
                                       :disabled="show">Send CV</a>
                                @endif
                            </div>
...
<script>
    new Vue({
        ...
        methods: {
            sendCv(student_id, topic_id) {
                this.show = !this.show;

                axios.post('/student/sendCv/' + student_id, {
                    topic_id
                }).then((response) = > {
                    alert('Done'
            )
