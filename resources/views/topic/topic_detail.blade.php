                        ...
                        <div class="col-lg-3">
                            <div class="blog-single-sidebar bordered blog-container">
                                <div class="blog-single-sidebar-search" id="aspiration">
                                    @if(Auth::user()->role == "student" && $stdAssigned == 0 && $countNumberAspiration
                                    <
                                        3) <a class="btn btn-success" @click="sendCv('{{Auth::user()->user_id}}','{{$topic_id->topic_id}}')"
    ...
    <div class="page-footer">
        <div class="page-footer-inner"> 2016 &copy; Metronic Theme By
            ...
            <a href="http://themeforest.net/item/metronic-responsive-admin-dashboard-template/4021469?ref=keenthemes" title="Purchase Metronic just for 27$ and get lifetime updates for free"
                target="_blank">Purchase Metronic!
            </a>
        </div>
