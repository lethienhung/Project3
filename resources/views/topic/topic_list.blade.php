    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <div class="cbp-search">
                ...
                <input id="js-search-blog-posts" type="text" placeholder="Search by title"
                       data-search=".cbp-l-grid-projects-title" class="cbp-search-input">
            ...
            <div class="portfolio-content portfolio-1">
                <div id="js-filters-juicy-projects" class="cbp-l-filters-button">
                    ...
                    @foreach($fieldList as $field)
                        <div data-filter=".{{str_replace(' ','-',$field->field_name)}}"
                             class="cbp-filter-item btn dark btn-outline uppercase"> {{$field->field_name}}
                            <div class="cbp-filter-counter"></div>
                        </div>
                    @endforeach
                ...
                <div id="js-grid-juicy-projects" class="cbp">
                    @foreach($topic as $tp)
                        <div class="cbp-item {{str_replace(' ','-',$tp->field_name)}}">
                                ...
                                <div class="cbp-caption-activeWrap">
                                    <div class="cbp-l-caption-alignCenter">
                                        <div class="cbp-l-caption-body">
                                            <a href="/topic/{{$tp->topic_id}}" target="_blank"
                            ...
                            <div class="cbp-l-grid-projects-desc uppercase text-center uppercase text-center">{{$tp->field_name}}
                                / {{$tp->skills_name}}</div>
                        </div>
                    @endforeach
