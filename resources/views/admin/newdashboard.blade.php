                                            ...
                                            <div class="mt-widget-2">
                                                <div class="mt-head" style="background-image: url(../assets/pages/img/background/32.jpg);">
                                                    <div class="mt-head-label">
                                                        <button type="button" class="btn btn-success">Truy cập</button>
                                                    </div>
                                                ...
                                                <div class="mt-body">
                                                    <h3 class="mt-body-title"> Quản lý người dùng </h3>
                                                    <p class="mt-body-description"> Với chức năng này, admin có thể đăng ký thêm người dùng, xóa người dùng, chỉnh sửa quyền truy cập </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
